...
public class StringLib {
    protected final static String logo = "_____         _         _____  __  ___  ___                _         _______ ________  ____  \n"
            + "|_   _|       | |       |  _  |/ _| |  \\/  |               ( )       / /_   _|  _  |  \\/  \\ \\ \n"
            ...
            + "                                                                     \\_\\                  /_/ \n";
    protected final static String WELCOME_MESSAGE = "\nHELLLOO there! I am \n "
            + logo + '\n'
    ...
    protected final static String HELP = "\nHelp is here! You may find the list of commands below useful. \n \n \n"
            ...
            + "Format      : \"add n/<insert recipe name> i/<insert ingredients with \", \" separation> t/<insert cuisine>\"\n"
            ...
            + "## View ## \n"
            + "Description : Displays the details of a particular recipe from the recipe list. Requires either the recipe name or index as the input. \n"
            + "Format      : \"view n/<insert recipe name>\" or \"view <insert recipe index on list>\" \n"
            + "Example use : \"view n/Hotpot\" or \"view 1\" \n \n"
            + "## Find ## \n"
            + "Description : Finds all recipes names containing keywords inputted in the description. Requires keywords as an input. \n"
            + "Format      : \"find <insert keywords>\" \n"
            + "Example use : \"find sushi\" \n \n"
            + "## Delete ## \n"
            + "Description : Removes a recipe from the recipe list, if it exists. Requires the recipe index on the list as an input. \n"
    ...
    protected final static String EXIT_MESSAGE = "\nBye. Hope to see you again soon!\n";
    protected final static String EMPTY_LIST_MESSAGE = "\nMATE! Your list is empty!\n";
    protected final static String NO_MATCHING_FIND_RESULTS_MESSAGE = "\nSeems like you do not have any recipes matching: ";
    ...
    protected final static String DUDE_MAIN_ERROR = "\nError in my run method!"
            + "\nException occurred : ";
    protected final static String UNRECOGNIZABLE_ERROR = "\nOOPS!!! I'm sorry, but I don't know what that means"
            + "\nTry typing \"help\" to see the valid commands you can use!\n";
    protected final static String MISSING_INPUTS_ERROR = "\nError in inputs!"
            + "\nException occurred: ";
    protected final static String PREFIX_EMPTY_LIMIT_LIST_ERROR = "\nError in finding index!"
    ...
    protected final static String SUFFIX_EMPTY_LIMIT_LIST_ERROR = " command yet! Try filling up the list first!\n";

    protected final static String RECIPE_ADDING_DEFAULT_ERROR = "\nError in adding recipe!"
            + "\nException occurred: ";
    protected final static String RECIPE_DELETING_DEFAULT_ERROR = "\nError in deleting recipe!"
            + "\nException occurred: ";
    protected final static String RECIPE_FINDING_DEFAULT_ERROR = "\nError in finding recipe!"
            + "\nException occurred: ";
    protected final static String FORMAT_CONVERT_ERROR = "\nError in inputs!"
    ...
    protected final static String MISSING_DESCRIPTION_ERROR = "\nError in description of inputs!"
            + "\nException occurred: ";
    protected final static String PARSING_STRING_ERROR = "\nError in parsing string!"
            + "\nException occurred: ";
    protected final static String FILE_NOT_FOUND_ERROR = "\nError in finding file!"
            + "\nException occurred: ";
    protected final static String FILE_PARSE_READING_ERROR = "\nError in reading file!"
            + "\nException occurred: ";
    protected final static String FILE_IO_ERROR = "\nError in file IO!"
            + "\nException occurred: ";
    protected final static String FILE_LOADING_DEFAULT_ERROR = "\nError in loading file!"
            + "\nException occurred: ";

    protected final static String LINE = "__________________________________________________________";
