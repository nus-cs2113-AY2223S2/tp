...
public enum Messages {
    ...
    MISSING_CONFIG("Your configuration file was not found. Default settings will be loaded instead."),
    LOAD_CONFIG("Your configuration file has been loaded successfully."),
    ...
    EDIT_CONFIG_INFO("Okay, I have changed the configuration to as follows:"),
