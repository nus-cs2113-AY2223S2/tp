...
public enum ErrorMessage {
    ...
    WRONG_DELETE_INDEX("Sorry, your delete command is invalid. Please ensure delete index is a number and" +
    ...
    WRONG_EDIT_FORMAT("Sorry, your edit command is invalid. Edit format is as follows: \n" +
            ...
            "Please refer to 'help' for more information!"),
    WRONG_EDIT_INDEX("Sorry, your edit command is invalid. Please ensure ignore index is a number " +
    ...
    WRONG_SHORTCUT_FORMAT("Sorry, your shortcut command is invalid. Shortcut format is as follows: \n" +
            ...
            "Please refer to 'help' for more information!"),
    WRONG_IGNORE_INDEX("Sorry, your ignore command is invalid. Please ensure ignore index is a number " +
            "and is within the boundary > 0 and <= %s"),
