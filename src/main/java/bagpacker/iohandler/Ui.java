...
public class Ui {
    ...
    public static void helpMessage() {
        ...
        System.out.println("3. " + PackCommand.HELP_MSG);
        System.out.println("4. " + PackAllCommand.HELP_MSG);
        System.out.println("5. " + UnpackCommand.HELP_MSG);
        System.out.println("6. " + UnpackAllCommand.HELP_MSG);
        System.out.println("7. " + EditQuantityCommand.HELP_MSG);
        System.out.println("8. " + ListCommand.HELP_MSG);
        System.out.println("9. " + ListUnpackedCommand.HELP_MSG);
        System.out.println("10. " + DeleteListCommand.HELP_MSG);
