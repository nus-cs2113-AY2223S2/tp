...
class StorageTest {
    private static final String PROPER_DATA_SAVE_FILE = "./src/test/data/properDataSaveFile.json";
    private static final String PROPER_CONFIG_SAVE_FILE = "./src/test/data/properConfigSaveFile.json";
    ...
    private Storage storage = new Storage(PROPER_DATA_SAVE_FILE, PROPER_CONFIG_SAVE_FILE);
    ...
    void saveData_properFilePath_success() {
        try {
            ...
            String savedTaskListString = new String(Files.readAllBytes(Paths.get(PROPER_DATA_SAVE_FILE)));
    ...
    void saveData_directoryAsFilePath_exceptionThrown() {
        try {
            Storage storageDirectory = new Storage(TEST_DATA_FOLDER, TEST_DATA_FOLDER);
            storageDirectory.save(taskList, config);
    ...
    void loadData_fileWithInvalidData_exceptionThrown() {
        try {
            Storage storageInvalid = new Storage(INVALID_SAVE_FILE, INVALID_SAVE_FILE);
