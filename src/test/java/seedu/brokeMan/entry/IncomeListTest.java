...
public class IncomeListTest {
    ...
    public static void setUp() {
        income1 = new Income(2000.0, "Salary", LocalDateTime.of(2023, Month.APRIL, 1, 10, 0), Category.SALARY);
        income2 = new Income(500.0, "Bonus", LocalDateTime.of(2023, Month.APRIL, 15, 15, 30), Category.SALARY);
    ...
    public void testAddIncome_validIncome_success() {
        Income income3 = new Income(100.0, "Allowance", LocalDateTime.of(2023, Month.APRIL, 25, 12, 0), Category.OTHERS);
