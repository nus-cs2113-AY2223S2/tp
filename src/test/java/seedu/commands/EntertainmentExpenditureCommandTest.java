...
public class EntertainmentExpenditureCommandTest {
        ...
        // EntertainmentExpenditureCommand testEntertainmentExpenditureCommand = new
        // EntertainmentExpenditureCommand(
        // "darts",
        // 10,
        // LocalDate.parse("2023-03-01"));
        // assertEquals("Added entertainment expenditure: [Entertainment] || Date: 1 Mar
        // 2023 || Value: 10.0 " +
        // "|| Description: darts",
        // testEntertainmentExpenditureCommand.execute(testExpenditures).getCommandResult());
        // assertEquals("1. [Entertainment] || Date: 1 Mar 2023 || Value: 10.0 ||
        // Description: darts",
        ...
        // @Test
        // public void
        // test_entertainmentExpenditureCommand_executeWithExpendituresAlreadyInList() {
        ...
        // "|| Description: darts",
        // testEntertainmentExpenditureCommand.execute(testExpenditures).getCommandResult());
        // assertEquals("1. [Academic] || Date: 1 Aug 2021 || Value: 1500.0 ||
        // Description: laptop\n" +
        // "2. [Entertainment] || Date: 1 Mar 2023 || Value: 10.0 || Description:
        // darts",
        // testExpenditures.toString());
        // }
}
