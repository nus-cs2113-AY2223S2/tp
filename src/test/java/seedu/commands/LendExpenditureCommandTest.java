...
class LendExpenditureCommandTest {
    ...
    // LendExpenditureCommand testLendExpenditureCommand = new
    ...
    // assertEquals("Added lend expenditure: [Lend] || Lent to: bombino || Date: 1
    // Aug 2021 || Value: 200.5 " +
    // "|| Description: for a friend || by: 5 May 2025",
    // testLendExpenditureCommand.execute(testExpenditures).getCommandResult());
    // assertEquals("1. [Lend] || Lent to: bombino || Date: 1 Aug 2021 || Value:
    // 200.5 || " +
    ...
    // @Test
    // public void
    // test_lendExpenditureCommand_executeWithExpendituresAlreadyInList() {
    ...
    // Description: laptop\n" +
    // "2. [Lend] || Lent to: bombino || Date: 1 Aug 2021 || Value: 200.5 ||
