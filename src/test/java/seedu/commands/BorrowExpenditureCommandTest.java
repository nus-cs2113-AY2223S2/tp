...
public class BorrowExpenditureCommandTest {
    ...
    // BorrowExpenditureCommand testBorrowExpenditureCommand = new
    ...
    // assertEquals("Added borrow expenditure: [Borrow] || Borrowed from: DBS ||
    // Date: 1 Aug 2021 " +
    // "|| Value: 20000.0 || Description: loan || By: 5 May 2025",
    // testBorrowExpenditureCommand.execute(testExpenditures).getCommandResult());
    // assertEquals("1. [Borrow] || Borrowed from: DBS || Date: 1 Aug 2021 || Value:
    // 20000.0 " +
    ...
    // @Test
    // public void
    // test_borrowExpenditureCommand_executeWithExpendituresAlreadyInList() {
