...
* [GitHub User Guide for BadMaths ➕➖✖️➗](#github-user-guide-for-badmaths-)
  ...
  * [Features](#features)
    ...
    * [16) Display All Notes Of A Certain Priority Type: `FindPrior`](#15--display-all-notes-of-a-certain-priority-type--findprior)
    * [17) Solving Quadratic Equations: `Quadratic`](#16--solving-quadratic-equations--quadratic)
    * [18) Command History `History`](#17--command-history-history)
    * [19) Help Manual `Help`](#18--help-manual-help)
    * [20) Exit BadMaths `Bye`](#19--exit-badmaths-bye)
  * [FAQ](#faq)
